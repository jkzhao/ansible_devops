...
# 脚本方式调试需要打开下面几行注释，因为用到了django的配置文件
# import os,sys
# PROJECT_ROOT = '/Users/jkzhao/Documents/study/github/ansible_devops'
# sys.path.insert(0,PROJECT_ROOT)
# os.environ["DJANGO_SETTINGS_MODULE"] = 'ansible_devops.settings'
# import django
# django.setup()
...
from ansible_devops.settings import BASE_DIR
...
if __name__ == '__main__':
    ...
    resource = { #字典形式
                    "dynamic_host": {
                        "hosts": [
                                    {'username': 'root', 'password': '123456', 'ip': '172.16.206.32', 'hostname': 'nginx01', 'port':'22'},
                                    {"hostname": "778da6afsdwf", "ip": "172.16.206.30", "port": "22", "username": "root", "password":"123456"},
                                  ],
                        "vars": {
                                 "var1":"ansible",
                                 "var2":"saltstack"
